...
Сценарий: Я проверяю ролевую доступность Организаций в списке ОбъектыГруппы "ИмяТаблицы", "РольПользователя"
	И таблица "[ИмяТаблицы]" равна макету "[РольПользователя]_[ИмяТаблицы]_ПоУмолчанию"
	...
	ИначеЕсли В активном окне открылась форма с заголовком "Поручения" Тогда
		И таблица "[ИмяТаблицы]" равна макету "[РольПользователя]_[ИмяТаблицы]_ПоУмолчанию"
	Иначе
		И таблица "[ИмяТаблицы]" равна макету "[РольПользователя]_[ИмяТаблицы]_Развернуто"
